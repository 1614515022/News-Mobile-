...
export default {
    ...
    async created() {
        this.readData = localStorage.getItem('readList')
       
        //console.log(localStorage.getItem('readList'))
        //console.log(this.readData)
        let regex = /izn[a-z]{4}\d{7}/igs
        this.model.readList = this.readData.match(regex)

        //console.log(this.model.readList)
        let res = await this.$http.post('/getRead',this.model)
        //console.log(res)
